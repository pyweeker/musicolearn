...
INDEX_TO_INTERNATIONAL = {0:'C3', 1:'C#3', 2:'D3', 3:'D#3', 4:'E3', 5:'F3', 6:'F#3', 7:'G3', 8:'G#3', 9:'A3', 10:'A#3', 11:'B3', 12:'C4', 13:'C#4', 14:'D4', 15:'D#4', 16:'E4', 17:'F4', 18:'F#4', 19:'G4', 20:'G#4', 21:'A4', 22:'A#4', 23:'B4', 24:'C5', 25:'C#5', 26:'D5', 27:'D#5', 28:'E5', 29:'F5', 30:'F#5', 31:'G5', 32:'G#5', 33:'A5', 34:'A#5', 35:'B5'}
#INDEX_TO_FR = {0:'Do', 1:'Re', 2:'Mi', 3:'Fa', 4:'Sol', 5:'La', 6:'Si'}
#  !!!!!!!!!!!!! PAS DE DIESE / BEMOL ni OCTAVE ICI !!!!!!!!!!!!!!!!!
...
class GameWindow(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        self.C3_sound = arcade.load_sound("./resources/sounds/C3.wav")
        self.D3_sound = arcade.load_sound("./resources/sounds/D3.wav")
        self.E3_sound = arcade.load_sound("./resources/sounds/E3.wav")
        self.F3_sound = arcade.load_sound("./resources/sounds/F3.wav")
        self.G3_sound = arcade.load_sound("./resources/sounds/G3.wav")
        self.A3_sound = arcade.load_sound("./resources/sounds/A3.wav")
        self.B3_sound = arcade.load_sound("./resources/sounds/B3.wav")
        ...
        self.sounds_list = [self.C3_sound,self.D3_sound,self.E3_sound,self.F3_sound,self.G3_sound,self.A3_sound,self.B3_sound, self.C4_sound,self.D4_sound,self.E4_sound,self.F4_sound,self.G4_sound,self.A4_sound,self.B4_sound]
    ...
    def fill_fuckingdict(self):
        ...
        #NB_TEXTURES_IN_INIT_TEXTURES_LAYER = (7 neutres + 5 dieses) * 3 octaves = 36
        NB_TEXTURES_IN_INIT_TEXTURES_LAYER = 36
    ...
    def setup(self):
        ...
        map_name = "resources/json_maps/map_oct_345.json"
    ...
    def on_update(self, delta_time):
        ...
        for sortedchord in no_duplicata_list:
            ...
            print(f"   sortedchord.texture  {sortedchord.texture}  ___ id  {id(sortedchord.texture)} >>>>>     sortedchord.texture.ident {ident}   <<< {anglosax}  ")
